# -*- coding: utf-8 -*-
#
# urusstudio documentation build configuration file, created by
...
project = u'Urus System'
copyright = u'2016, Urus Team'
author = u'Urus Team'
...
latex_documents = [
    (master_doc, 'urusstudio.tex', u'urusstudio Documentation',
     u'Urus Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'urusstudio', u'urusstudio Documentation',
     [author], 1)
]
