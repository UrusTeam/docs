# -*- coding: utf-8 -*-
#
# UrusSystem documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'UrusSystem.tex', u'UrusSystem Documentation',
     u'Urus Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'UrusSystem', u'UrusSystem Documentation',
     [author], 1)
]
